...
var ttLockModule = _reactNative.NativeModules.Ttlock;
var ttLockEventEmitter = new _reactNative.NativeEventEmitter(ttLockModule);
var subscriptionMap = new Map();
var TtWirelessKeypad = exports.TtWirelessKeypad = /*#__PURE__*/function () {
  function TtWirelessKeypad() {
    _classCallCheck(this, TtWirelessKeypad);
  }
  return _createClass(TtWirelessKeypad, null, [{
    key: "initTtlockBle",
    value: function initTtlockBle(callback) {
      callback = callback || this.defaultCallback;
      ttLockModule.initTtlockBle(callback);
    }
  }, {
    key: "startScan",
    value: function startScan(callback) {
      var subscription = subscriptionMap.get(WirelessKeypadEvent.ScanWirelessKeypad);
    ...
    key: "init",
    value: function init(mac, lockMac, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.initWirelessKeypad(mac, lockMac, function (dataArray) {
        success(dataArray[0], dataArray[1]);
      }, function (errorCode) {
        var description = "Init wireless keypad fail.";
...
var TtDoorSensor = exports.TtDoorSensor = /*#__PURE__*/function () {
  function TtDoorSensor() {
    _classCallCheck(this, TtDoorSensor);
  }
  return _createClass(TtDoorSensor, null, [{
    key: "startScan",
    value: function startScan(callback) {
      var subscription = subscriptionMap.get(TtDoorSensorEvent.ScanDoorSensor);
      if (subscription !== undefined) {
        subscription.remove();
      }
    ...
    key: "init",
    value: function init(mac, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.initDoorSensor(mac, lockData, function (dataArray) {
        success(dataArray[0], dataArray[1]);
      }, function (errorCode) {
        var description = "Init door sensor fail.";
...
var TtRemoteKey = exports.TtRemoteKey = /*#__PURE__*/function () {
  function TtRemoteKey() {
    _classCallCheck(this, TtRemoteKey);
  }
  return _createClass(TtRemoteKey, null, [{
    key: "startScan",
    value: function startScan(callback) {
      var subscription = subscriptionMap.get(TtRemoteKeyEvent.ScanRemoteKey);
      if (subscription !== undefined) {
        subscription.remove();
      }
    ...
    value: function init(mac, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.initRemoteKey(mac, lockData, function (dataArray) {
        success(dataArray[0], dataArray[1]);
      }, function (errorCode) {
        var description = "Init remote key fail.";
...
var TtGateway = exports.TtGateway = /*#__PURE__*/function () {
  function TtGateway() {
    _classCallCheck(this, TtGateway);
  }
  return _createClass(TtGateway, null, [{
    key: "startScan",
    value:
    /**
    ...
    function startScan(callback) {
      var subscription = subscriptionMap.get(GatewayEvent.ScanGateway);
      if (subscription !== undefined) {
        subscription.remove();
      }
    ...
    key: "connect",
    value: function connect(mac, callback) {
      callback = callback || this.defaultCallback;
      ttLockModule.connect(mac, function (state) {
        var connectState = [ConnectState.Timeout, ConnectState.Success, ConnectState.Fail][state];
    ...
    key: "getNearbyWifi",
    value: function getNearbyWifi(progress, finish, fail) {
      progress = progress || this.defaultCallback;
      finish = finish || this.defaultCallback;
      fail = fail || this.defaultCallback;
      var subscription = ttLockEventEmitter.addListener(GatewayEvent.ScanWifi, function (responseData) {
        progress(responseData);
      });
      ttLockModule.getNearbyWifi(function (state) {
        subscription.remove();
        if (state === 0) {
          finish();
        } else {
    ...
    key: "initGateway",
    value: function initGateway(object, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.initGateway(object, success, function (errorCode) {
        var description = "Init gateway fail.";
        if (errorCode === 3) {
...
var Ttlock = exports.Ttlock = /*#__PURE__*/function () {
  function Ttlock() {
    _classCallCheck(this, Ttlock);
  }
  return _createClass(Ttlock, null, [{
    key: "startScan",
    value:
    /**
     ...
     */
    function startScan(callback) {
      var subscription = subscriptionMap.get(TTLockEvent.ScanLock);
      if (subscription !== undefined) {
        subscription.remove();
      }
      callback = callback || this.defaultCallback;
    ...
    key: "initLock",
    value: function initLock(object, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.initLock(object, success, fail);
    }
  }, {
    key: "getLockVersionWithLockMac",
    value: function getLockVersionWithLockMac(lockMac, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getLockVersionWithLockMac(lockMac, success, fail);
    }
  }, {
    key: "getAccessoryElectricQuantity",
    value: function getAccessoryElectricQuantity(accessoryType, accessoryMac, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getAccessoryElectricQuantity(accessoryType, accessoryMac, lockData, function (dataArray) {
        success(dataArray[0], dataArray[1]);
      }, fail);
    }
    ...
    key: "resetLock",
    value: function resetLock(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "resetEkey",
    value: function resetEkey(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "controlLock",
    value: function controlLock(control, lockData, success, fail) {
      fail = fail || this.defaultCallback;
      success = success || this.defaultCallback;
      ttLockModule.controlLock(control, lockData, function (dataArray) {
    ...
    key: "createCustomPasscode",
    value: function createCustomPasscode(passcode, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "modifyPasscode",
    value: function modifyPasscode(passcodeOrigin, passcodeNew, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "deletePasscode",
    value: function deletePasscode(passcode, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "resetPasscode",
    value: function resetPasscode(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "getLockSwitchState",
    value: function getLockSwitchState(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getLockSwitchState(lockData, function (state) {
        var lockState = [LockState.Locked, LockState.Unlock, LockState.Unknown, LockState.CarOnLock][state];
        success(lockState);
      }, fail);
    }
    ...
    key: "addCard",
    value: function addCard(cycleList, startDate, endDate, lockData, progress, success, fail) {
      progress = progress || this.defaultCallback;
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleList = cycleList || [];
      var subscription = ttLockEventEmitter.addListener(TTLockEvent.AddCardProgress, function () {
        progress();
      });
      ttLockModule.addCard(cycleList, startDate, endDate, lockData, function (cardNumber) {
        subscription.remove();
        success(cardNumber);
      }, function (errorCode, errorDesc) {
        subscription.remove();
    ...
    key: "modifyCardValidityPeriod",
    value: function modifyCardValidityPeriod(cardNumber, cycleList, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleList = cycleList || [];
    ...
    key: "deleteCard",
    value: function deleteCard(cardNumber, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "clearAllCards",
    value: function clearAllCards(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "addFingerprint",
    value: function addFingerprint(cycleList, startDate, endDate, lockData, progress, success, fail) {
      progress = progress || this.defaultCallback;
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleList = cycleList || [];
      var subscription = ttLockEventEmitter.addListener(TTLockEvent.AddFingerprintProgress, function (dataArray) {
        progress(dataArray[0], dataArray[1]);
      });
      ttLockModule.addFingerprint(cycleList, startDate, endDate, lockData, function (fingerprintNumber) {
        subscription.remove();
    ...
    key: "modifyFingerprintValidityPeriod",
    value: function modifyFingerprintValidityPeriod(fingerprintNumber, cycleList, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleList = cycleList || [];
    ...
    key: "deleteFingerprint",
    value: function deleteFingerprint(fingerprintNumber, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "clearAllFingerprints",
    value: function clearAllFingerprints(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "modifyAdminPasscode",
    value: function modifyAdminPasscode(adminPasscode, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "setLockTime",
    value: function setLockTime(timestamp, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "getLockTime",
    value: function getLockTime(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "getLockSystem",
    value: function getLockSystem(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getLockSystem(lockData, success, fail);
    }
  }, {
    key: "getLockElectricQuantity",
    value: function getLockElectricQuantity(lockData, success, fail) {
      fail = fail || this.defaultCallback;
      success = success || this.defaultCallback;
    ...
    key: "getLockOperationRecord",
    value: function getLockOperationRecord(type, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "getLockAutomaticLockingPeriodicTime",
    value: function getLockAutomaticLockingPeriodicTime(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getLockAutomaticLockingPeriodicTime(lockData, function (data) {
    ...
    key: "setLockAutomaticLockingPeriodicTime",
    value: function setLockAutomaticLockingPeriodicTime(seconds, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "getLockRemoteUnlockSwitchState",
    value: function getLockRemoteUnlockSwitchState(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "setLockRemoteUnlockSwitchState",
    value: function setLockRemoteUnlockSwitchState(isOn, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "getLockConfig",
    value: function getLockConfig(config, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getLockConfig(config, lockData, function (data) {
    ...
    key: "setLockConfig",
    value: function setLockConfig(config, isOn, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.setLockConfig(config, isOn, lockData, success, fail);
    }
  }, {
    key: "setLockSoundVolume",
    value: function setLockSoundVolume(soundVolume, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.setLockSoundVolume(soundVolume, lockData, success, fail);
    }
  }, {
    key: "getLockSoundVolume",
    value: function getLockSoundVolume(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getLockSoundVolume(lockData, success, fail);
    }
  }, {
    key: "getUnlockDirection",
    value: function getUnlockDirection(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getUnlockDirection(lockData, success, fail);
    }
  }, {
    key: "setUnlockDirection",
    value: function setUnlockDirection(direction, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.setUnlockDirection(direction, lockData, success, fail);
    }
  }, {
    key: "setUnlockDirectionAutomatic",
    value: function setUnlockDirectionAutomatic(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "addPassageMode",
    value: function addPassageMode(mode, days, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      var weekly = LockPassageMode.Weekly === mode ? days : [];
      var monthly = LockPassageMode.Monthly === mode ? days : [];
    ...
    key: "clearAllPassageModes",
    value: function clearAllPassageModes(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "addRemoteKey",
    value: function addRemoteKey(remoteKeyMac, cycleDateList, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "modifyRemoteKey",
    value: function modifyRemoteKey(remoteKeyMac, cycleDateList, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleDateList = cycleDateList || [];
    ...
    key: "deleteRemoteKey",
    value: function deleteRemoteKey(remoteKeyMac, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.deleteRemoteKey(remoteKeyMac, lockData, success, fail);
    }
  }, {
    key: "clearAllRemoteKey",
    value: function clearAllRemoteKey(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "addDoorSensor",
    value: function addDoorSensor(doorSensorMac, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.addDoorSensor(doorSensorMac, lockData, success, fail);
    }
  }, {
    key: "clearAllDoorSensor",
    value: function clearAllDoorSensor(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.clearAllDoorSensor(lockData, success, fail);
    }
  }, {
    key: "setDoorSensorAlertTime",
    value: function setDoorSensorAlertTime(time, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "recoverCard",
    value: function recoverCard(cardNumber, cycleList, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleList = cycleList || [];
    ...
    key: "recoverPasscode",
    value: function recoverPasscode(passcode, passcodeType, cycleType, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "scanWifi",
    value: function scanWifi(lockData, callback, fail) {
      var subscription = subscriptionMap.get(TTLockEvent.ScanLockWifi);
      if (subscription !== undefined) {
        subscription.remove();
      }
      subscription = ttLockEventEmitter.addListener(TTLockEvent.ScanLockWifi, function (data) {
    ...
    key: "configWifi",
    value: function configWifi(wifiName, wifiPassword, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "configServer",
    value: function configServer(ip, port, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "getWifiInfo",
    value: function getWifiInfo(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.getWifiInfo(lockData, function (data) {
        success(data[0], data[1]);
      }, fail);
    }
  }, {
    key: "getWifiPowerSavingTime",
    value: function getWifiPowerSavingTime(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "configWifiPowerSavingTime",
    value: function configWifiPowerSavingTime(weekDays, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.configWifiPowerSavingTime(weekDays, startDate, endDate, lockData, success, fail);
    }
  }, {
    key: "clearWifiPowerSavingTime",
    value: function clearWifiPowerSavingTime(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "configIp",
    value: function configIp(info, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "addFace",
    value: function addFace(cycleList, startDate, endDate, lockData, progress, success, fail) {
      progress = progress || this.defaultCallback;
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleList = cycleList || [];
      var subscription = ttLockEventEmitter.addListener(TTLockEvent.AddFaceProgress, function (dataArray) {
        progress(dataArray[0], dataArray[1]);
      });
      ttLockModule.addFace(cycleList, startDate, endDate, lockData, function (cardNumber) {
        subscription.remove();
        success(cardNumber);
      }, function (errorCode, errorDesc) {
        subscription.remove();
    ...
    key: "addFaceFeatureData",
    value: function addFaceFeatureData(faceFeatureData, cycleList, startDate, endDate, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleList = cycleList || [];
      ttLockModule.addFaceFeatureData(faceFeatureData, cycleList, startDate, endDate, lockData, function (faceNumber) {
        success(faceNumber);
      }, function (errorCode, errorDesc) {
        fail(errorCode, errorDesc);
      });
    ...
    key: "modifyFaceValidityPeriod",
    value: function modifyFaceValidityPeriod(cycleList, startDate, endDate, faceNumber, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      cycleList = cycleList || [];
    ...
    key: "deleteFace",
    value: function deleteFace(faceNumber, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "clearAllFace",
    value: function clearAllFace(lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "activateLiftFloors",
    value: function activateLiftFloors(floors, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
      ttLockModule.activateLiftFloors(floors, lockData, function (dataArray) {
        success(dataArray[0], dataArray[1], dataArray[2]);
      }, fail);
    }
    ...
    key: "setLiftControlEnableFloors",
    value: function setLiftControlEnableFloors(floors, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    key: "setLiftWorkMode",
    value: function setLiftWorkMode(workMode, lockData, success, fail) {
      success = success || this.defaultCallback;
      fail = fail || this.defaultCallback;
    ...
    */
    ...
    value: function getBluetoothState(callback) {
      callback = callback || this.defaultCallback;
      ttLockModule.getBluetoothState(function (state) {
    ...
    key: "supportFunction",
    value: function supportFunction(lockFunction, lockData, callback) {
...
var BluetoothState = exports.BluetoothState = /*#__PURE__*/function (BluetoothState) {
  ...
  BluetoothState[BluetoothState["Off"] = 4] = "Off";
  BluetoothState[BluetoothState["On"] = 5] = "On";
